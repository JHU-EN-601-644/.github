...
1. [Cardio Crisis](https://github.com/JHU-EN-601-644/CardioCrisisCrew): ECG sensors monitor heart activity placed on the body and connect to an SBC that transmits the data via Bluetooth to a smartphone application. It can detect cardiac irregularities in real time, enabling medical personnel to respond quickly.
...
3. [NeuroMotion](https://github.com/JHU-EN-601-644/DARKside): Tracks movement and other medical data for patients who have Parkinson's disease to determine if treatment is beneficial. It helps patients track their progress and optimize treatment plans, which can support better recovery and positive mental health outcomes.
...
5. [ThermaTrack](https://github.com/JHU-EN-601-644/therma_track): Real-time tracking of a patient's body temperature that can alert caregivers when it detects abnormal variations. The data is stored securely in the AWS cloud, providing direct access to the collected data via a web and mobile application.
